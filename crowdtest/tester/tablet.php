...
include ('../connection.php');
  if(empty($_SESSION) && $_SESSION['user_type'] != 'TESTER'){
    ...
    if(isset($_POST["btnSubmit"]))
    {
      ...
      $q=mysqli_query($conn,"INSERT INTO tablet(device_name,manufacture,model,os,browser,version,tester_id)VALUES('$Name','$Manufacture','$Model','$OSPC','Browser','$Version','Tester')") or die(mysqli_error($conn));
