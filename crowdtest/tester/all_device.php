...
<body>
  ...
  <div class="container">
  <div class="page-header" align="center"><h1>PC/Laptop</h1></div>
...
<?php
    $q=mysqli_query($conn,"SELECT * FROM  pc_laptop where tester_id =".$_SESSION['id']);
...
<?php
    ...
    $q=mysqli_query($conn,"SELECT * FROM  mobile where tester_id =".$_SESSION['id']);
...
<?php
    include ('../connection.php');
    $q=mysqli_query($conn,"SELECT * FROM  tablet where tester_id =".$_SESSION['id']);
