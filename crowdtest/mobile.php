...
include ('connection.php');
  if(empty($_SESSION) && $_SESSION['user_type'] != 'TESTER'){
    ...
    if(isset($_POST["btnSubmit"]))
    {
      ...
      $q=mysqli_query($conn,"INSERT INTO mobile(device_name,manufacture,model,os,browser,version)VALUES('$Name','$Manufacture','$Model','$OSPC','Browser','$Version')") or die(mysqli_error($conn));
