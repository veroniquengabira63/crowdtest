<?php
        ...
        if(isset($_POST["btnLogin"]))
        {
            $eid=$_POST["txtEid"];
            $pass=$_POST["txtPass"];
            $q = mysqli_query($conn,"SELECT * FROM employee_login WHERE email='$eid' AND password='".md5($pass)."'");
						...
						<div class="modal-body">				
							<form method="post"  class="form-group" action="">
								...
								<tr>
									...
									<td><button class="btn btn-warning" id="cancel"type="reset" name="btnCancel" value="cancel">Cancel</button></td>
								</tr>
